...
from google.generativeai import VertexAI
...
class GeminiCampaignAgent:
    def __init__(self, gemini_api_key: Optional[str] = None):
        ...
        self.vertex_ai = VertexAI(api_key=self.gemini_api_key)
        self.model = self.vertex_ai.get_model("gemini-1.5-pro")
